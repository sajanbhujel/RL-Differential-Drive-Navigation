...
The following demos show the trained MADDPG policy running in the ROS 2/Gazebo environment. The EduBot differential-drive robots navigate in the Gazebo arena using the trained actor policies.
